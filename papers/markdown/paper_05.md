---
title: "Food Cost Efficiency versus Nutrient Density: USDA FoodData Central Augmentation with Survey-Scale Trade-Offs"
author: "Park Minjae"
date: "2026-03-10"
---

# Food Cost Efficiency versus Nutrient Density: USDA FoodData Central Augmentation with Survey-Scale Trade-Offs
...
원고 날짜(Manuscript date): 2026-03-10
...
보고값은 `results/full_analysis.json`의 `papers["5"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_05_pca.png`, `figures/paper_05_scatter.png`, `figures/paper_05_clusters.png`, `figures/paper_05_trend.png`, `figures/paper_05_residuals.png`.

![PC1 variance](figures/paper_05_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_05_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_05_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_05_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_05_residuals.png)
