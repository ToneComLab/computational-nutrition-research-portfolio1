---
title: "Micronutrient Inadequacy Risk Scores from Recall-Derived Intakes: Threshold Models with Uncertainty Quantification"
author: "Park Minjae"
date: "2025-02-16"
---

# Micronutrient Inadequacy Risk Scores from Recall-Derived Intakes: Threshold Models with Uncertainty Quantification
...
원고 날짜(Manuscript date): 2025-02-16
...
보고값은 `results/full_analysis.json`의 `papers["6"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_06_pca.png`, `figures/paper_06_scatter.png`, `figures/paper_06_clusters.png`, `figures/paper_06_trend.png`, `figures/paper_06_residuals.png`.

![PC1 variance](figures/paper_06_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_06_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_06_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_06_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_06_residuals.png)
