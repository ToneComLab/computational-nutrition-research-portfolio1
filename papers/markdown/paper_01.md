---
title: "Energy Density and Satiety-Proxy Constructs from 24-Hour Recall: A Cross-Sectional Energy–Volume Framework in NHANES Adults"
author: "Park Minjae"
date: "2026-04-21"
---

# Energy Density and Satiety-Proxy Constructs from 24-Hour Recall: A Cross-Sectional Energy–Volume Framework in NHANES Adults
...
원고 날짜(Manuscript date): 2026-04-21
...
보고값은 `results/full_analysis.json`의 `papers["1"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_01_pca.png`, `figures/paper_01_scatter.png`, `figures/paper_01_clusters.png`, `figures/paper_01_trend.png`, `figures/paper_01_residuals.png`.

![PC1 variance](figures/paper_01_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_01_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_01_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_01_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_01_residuals.png)
