---
title: "Bibliometric Trends in Functional Foods: PubMed Corpus Mining with Regression Slopes"
author: "Park Minjae"
date: "2025-08-10"
---

# Bibliometric Trends in Functional Foods: PubMed Corpus Mining with Regression Slopes
...
원고 날짜(Manuscript date): 2025-08-10
...
보고값은 `results/full_analysis.json`의 `papers["26"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_26_pca.png`, `figures/paper_26_scatter.png`, `figures/paper_26_clusters.png`, `figures/paper_26_trend.png`, `figures/paper_26_residuals.png`.

![PC1 variance](figures/paper_26_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_26_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_26_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_26_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_26_residuals.png)
