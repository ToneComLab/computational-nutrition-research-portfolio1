---
title: "PCA-Based Nutritional Archetypes with Interpretable Loading Vectors and Component Scores"
author: "Park Minjae"
date: "2025-04-02"
---

# PCA-Based Nutritional Archetypes with Interpretable Loading Vectors and Component Scores
...
원고 날짜(Manuscript date): 2025-04-02
...
보고값은 `results/full_analysis.json`의 `papers["18"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_18_pca.png`, `figures/paper_18_scatter.png`, `figures/paper_18_clusters.png`, `figures/paper_18_trend.png`, `figures/paper_18_residuals.png`.

![PC1 variance](figures/paper_18_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_18_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_18_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_18_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_18_residuals.png)
