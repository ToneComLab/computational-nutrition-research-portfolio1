---
title: "Meta-Analytic Framing of Bioactive Compound Research: Systematic PubMed Enumeration with Heterogeneity Discussion"
author: "Park Minjae"
date: "2025-03-26"
---

# Meta-Analytic Framing of Bioactive Compound Research: Systematic PubMed Enumeration with Heterogeneity Discussion
...
원고 날짜(Manuscript date): 2025-03-26
...
보고값은 `results/full_analysis.json`의 `papers["30"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_30_pca.png`, `figures/paper_30_scatter.png`, `figures/paper_30_clusters.png`, `figures/paper_30_trend.png`, `figures/paper_30_residuals.png`.

![PC1 variance](figures/paper_30_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_30_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_30_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_30_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_30_residuals.png)
