---
title: "Citation-Network Proxy Analysis Using Publication Volume and Co-Term Occurrence Metrics"
author: "Park Minjae"
date: "2026-09-19"
---

# Citation-Network Proxy Analysis Using Publication Volume and Co-Term Occurrence Metrics
...
원고 날짜(Manuscript date): 2026-09-19
...
보고값은 `results/full_analysis.json`의 `papers["28"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_28_pca.png`, `figures/paper_28_scatter.png`, `figures/paper_28_clusters.png`, `figures/paper_28_trend.png`, `figures/paper_28_residuals.png`.

![PC1 variance](figures/paper_28_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_28_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_28_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_28_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_28_residuals.png)
