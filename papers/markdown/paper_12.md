---
title: "Global Caloric Supply and Obesity Prevalence: Ecological Coupling with World Bank and WHO Indicators"
author: "Park Minjae"
date: "2025-05-19"
---

# Global Caloric Supply and Obesity Prevalence: Ecological Coupling with World Bank and WHO Indicators
...
원고 날짜(Manuscript date): 2025-05-19
...
보고값은 `results/full_analysis.json`의 `papers["12"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_12_pca.png`, `figures/paper_12_scatter.png`, `figures/paper_12_clusters.png`, `figures/paper_12_trend.png`, `figures/paper_12_residuals.png`.

![PC1 variance](figures/paper_12_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_12_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_12_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_12_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_12_residuals.png)
