---
title: "Fiber Diversity Indices and Digestive-Health Proxies: Variance Decomposition in U.S. Adults"
author: "Park Minjae"
date: "2025-01-20"
---

# Fiber Diversity Indices and Digestive-Health Proxies: Variance Decomposition in U.S. Adults
...
원고 날짜(Manuscript date): 2025-01-20
...
보고값은 `results/full_analysis.json`의 `papers["7"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_07_pca.png`, `figures/paper_07_scatter.png`, `figures/paper_07_clusters.png`, `figures/paper_07_trend.png`, `figures/paper_07_residuals.png`.

![PC1 variance](figures/paper_07_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_07_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_07_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_07_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_07_residuals.png)
