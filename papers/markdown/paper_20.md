---
title: "Machine Learning Classification of Cardiometabolic Risk from Multivariate Nutrient Features"
author: "Park Minjae"
date: "2025-10-31"
---

# Machine Learning Classification of Cardiometabolic Risk from Multivariate Nutrient Features
...
원고 날짜(Manuscript date): 2025-10-31
...
보고값은 `results/full_analysis.json`의 `papers["20"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_20_pca.png`, `figures/paper_20_scatter.png`, `figures/paper_20_clusters.png`, `figures/paper_20_trend.png`, `figures/paper_20_residuals.png`.

![PC1 variance](figures/paper_20_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_20_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_20_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_20_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_20_residuals.png)
