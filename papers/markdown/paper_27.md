---
title: "Topic-Structured Survey of Nutrition Research Keywords via PubMed Frequency Dynamics"
author: "Park Minjae"
date: "2026-06-14"
---

# Topic-Structured Survey of Nutrition Research Keywords via PubMed Frequency Dynamics
...
원고 날짜(Manuscript date): 2026-06-14
...
보고값은 `results/full_analysis.json`의 `papers["27"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_27_pca.png`, `figures/paper_27_scatter.png`, `figures/paper_27_clusters.png`, `figures/paper_27_trend.png`, `figures/paper_27_residuals.png`.

![PC1 variance](figures/paper_27_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_27_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_27_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_27_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_27_residuals.png)
