---
title: "Macronutrient Ratio × Glycemic Load Interaction Surfaces and Cardiometabolic Proxies: NHANES-Based Inference"
author: "Park Minjae"
date: "2026-04-06"
---

# Macronutrient Ratio × Glycemic Load Interaction Surfaces and Cardiometabolic Proxies: NHANES-Based Inference
...
원고 날짜(Manuscript date): 2026-04-06
...
보고값은 `results/full_analysis.json`의 `papers["2"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_02_pca.png`, `figures/paper_02_scatter.png`, `figures/paper_02_clusters.png`, `figures/paper_02_trend.png`, `figures/paper_02_residuals.png`.

![PC1 variance](figures/paper_02_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_02_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_02_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_02_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_02_residuals.png)
