---
title: "Income Elasticity of Dietary Quality: PIR-Stratified Nutrient Density Models"
author: "Park Minjae"
date: "2025-03-30"
---

# Income Elasticity of Dietary Quality: PIR-Stratified Nutrient Density Models
...
원고 날짜(Manuscript date): 2025-03-30
...
보고값은 `results/full_analysis.json`의 `papers["15"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_15_pca.png`, `figures/paper_15_scatter.png`, `figures/paper_15_clusters.png`, `figures/paper_15_trend.png`, `figures/paper_15_residuals.png`.

![PC1 variance](figures/paper_15_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_15_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_15_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_15_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_15_residuals.png)
