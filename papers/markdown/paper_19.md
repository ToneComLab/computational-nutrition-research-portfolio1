---
title: "Predictive Modeling of Hypertension Status from Dietary Composition: Logistic Regression with ROC Diagnostics"
author: "Park Minjae"
date: "2026-03-03"
---

# Predictive Modeling of Hypertension Status from Dietary Composition: Logistic Regression with ROC Diagnostics
...
원고 날짜(Manuscript date): 2026-03-03
...
보고값은 `results/full_analysis.json`의 `papers["19"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_19_pca.png`, `figures/paper_19_scatter.png`, `figures/paper_19_clusters.png`, `figures/paper_19_trend.png`, `figures/paper_19_residuals.png`.

![PC1 variance](figures/paper_19_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_19_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_19_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_19_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_19_residuals.png)
