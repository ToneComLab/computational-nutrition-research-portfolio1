---
title: "Time-Series Nutrition Transition Analysis with External Macro Series Alignment"
author: "Park Minjae"
date: "2026-01-10"
---

# Time-Series Nutrition Transition Analysis with External Macro Series Alignment
...
원고 날짜(Manuscript date): 2026-01-10
...
보고값은 `results/full_analysis.json`의 `papers["24"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_24_pca.png`, `figures/paper_24_scatter.png`, `figures/paper_24_clusters.png`, `figures/paper_24_trend.png`, `figures/paper_24_residuals.png`.

![PC1 variance](figures/paper_24_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_24_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_24_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_24_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_24_residuals.png)
