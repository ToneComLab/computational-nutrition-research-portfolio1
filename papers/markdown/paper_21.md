---
title: "Temporal Trend Analysis of Sugar Intake Across NHANES Cycles with Structural Break Tests"
author: "Park Minjae"
date: "2026-06-08"
---

# Temporal Trend Analysis of Sugar Intake Across NHANES Cycles with Structural Break Tests
...
원고 날짜(Manuscript date): 2026-06-08
...
보고값은 `results/full_analysis.json`의 `papers["21"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_21_pca.png`, `figures/paper_21_scatter.png`, `figures/paper_21_clusters.png`, `figures/paper_21_trend.png`, `figures/paper_21_residuals.png`.

![PC1 variance](figures/paper_21_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_21_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_21_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_21_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_21_residuals.png)
