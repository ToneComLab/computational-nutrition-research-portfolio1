---
title: "Dietary Sodium-to-Potassium Ratio and Blood Pressure Phenotypes: Population Stratification with Confidence Intervals"
author: "Park Minjae"
date: "2025-06-12"
---

# Dietary Sodium-to-Potassium Ratio and Blood Pressure Phenotypes: Population Stratification with Confidence Intervals
...
원고 날짜(Manuscript date): 2025-06-12
...
보고값은 `results/full_analysis.json`의 `papers["3"]`에 저장됨. 유의확률은 양측 검정.
...
아래 그림은 300 DPI로 저장되었다: `figures/paper_03_pca.png`, `figures/paper_03_scatter.png`, `figures/paper_03_clusters.png`, `figures/paper_03_trend.png`, `figures/paper_03_residuals.png`.

![PC1 variance](figures/paper_03_pca.png)

*Figure 1. PCA explained variance ratios.*

![Nutrients](figures/paper_03_scatter.png)

*Figure 2. Nutrient–nutrient scatter.*

![Clusters](figures/paper_03_clusters.png)

*Figure 3. K-means cluster sizes.*

![Trend](figures/paper_03_trend.png)

*Figure 4. PubMed nutrition query trend.*

![Residuals](figures/paper_03_residuals.png)
